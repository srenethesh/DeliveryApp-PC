...
const SignUpPage = () => {
  ...
  return (
    ...
    <View style={styles.mailContainer}>
        <Text style={{fontSize:16 , color:"#050F2B"}}>Name:</Text>
        <TextInput style={{borderWidth:1,width:340,height:50,borderRadius:5 ,padding:10}} placeholder='Your Name' />
    </View>
    <View style={styles.mailContainer}>
    ...
    <View style={styles.pwdContainer}>
        <Text style={{fontSize:16 , color:"#050F2B"}}>Confirm Password:</Text>
        <TextInput style={{borderWidth:1,width:340,height:50,borderRadius:5 ,padding:10}} placeholder='example@123' />
    </View>
    <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('BottomNav')}>
        <Text style={{fontSize:14,fontWeight:'500',color:'#FFFFFF'}}>Sign Up</Text>
    </TouchableOpacity>
    <TouchableOpacity style={{marginTop:20}}>
        <Text style={{fontSize:14,color:'#8F8F8F'}}>Or</Text>
    </TouchableOpacity>
